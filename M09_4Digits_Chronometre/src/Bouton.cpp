...
Bouton::Bouton(uint8_t p_pin, Action* p_action) : m_pin(p_pin), m_actionBoutonPresse(p_action), m_dateDernierChangement(0), m_dernierEtat(HIGH), m_dernierEtatStable(HIGH)
{
